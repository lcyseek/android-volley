...
public class DiskBasedCache implements Cache {
     ...
     */
    /** //判断缓存是否需要经过优化... */
    //  这个函数的调用目的是对当前缓存数据大小的一个判断过程，如果缓存的数据大小小于指定的规格大小，那么直接就return就可以了，
    // 说明指定的大小可以满足缓存的存储大小，但是如果缓存的数据大小超出了我们预先指定的规格，那么我们需要对缓存数据进行优化，优化成可以满足预先指定的规格...具体优化的大小为0.9倍的指定的大小...
